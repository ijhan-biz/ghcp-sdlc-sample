...
require_text_in_file ".github/ISSUE_TEMPLATE/plan-change.yml" "id: owner" "plan template includes owner"
require_text_in_file ".github/ISSUE_TEMPLATE/plan-change.yml" "Stop condition" "plan template includes stop condition guidance"
